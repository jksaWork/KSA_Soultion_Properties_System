...
<small> - {{ __('translation.edit_cleint') }} </small>
@endsection
@push('links')
          ...
          <div class="card">
               ...
               <div class="card-header border-0 pt-6">
                    <div class="card-body pt-0">
                         ...
                         @include('layouts.includes.session')
                         <form action="{{ route('clients.update' , $client->id)}}" method="post" id='owner_form' enctype="multipart/form-data">
                              @csrf
                              @method('put')
                              <div class="border rodunded-sm ">
                                   ...
                                   <div class="row px-3 mt-3">
                                        ...
                                        <x:select2-input name='nationalaity' :value='$client->nationalaity_id' :option='$client->Nationalaity' class='col-md-6' />
                                        {{-- @dd(App\Models\Admin::IDTYPES) --}}
                                        <x:select-options name='id_type' :options="App\Models\Admin::IDTYPES" class='col-md-6' />
                                        <x:text-input class="col-md-6" :value='$client->id_number' name='id_number' />
                                   </div>
                              </div>
                                   ...
                                   <div class="row px-3 mt-3">
                                        <div class="form-group mb-2 col-md-6">
                                             ...
                                             <select id='province_select' style='width:100%' class='form-control' name='province_id'>
                                                  <option value='{{ $client->province_id }}'> {{ $client->Province->name ?? '' }}
                                                  </option>
                                             </select>
                                             @error('province_id')
                                        ...
                                        <div class="form-group mb-2 col-md-6">
                                             ...
                                             <select id='subarea_select' style='width:100%' class='form-control' name='subarea_id'>
                                                  <option value='{{ $client->subarea_id }}'> {{ $client->SubArea->name ?? '' }}
                                                  </option>
                                             </select>
                                             @error('subarea_id')
                                             <span class="text-danger">
                                        ...
                                        <x:text-input name='address' class='col-md-6' :value='$client->address' />
