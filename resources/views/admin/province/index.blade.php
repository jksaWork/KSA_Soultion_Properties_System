                    ...
                    <div class="row">
                        ...
                        <div class="modal fade" id="kt_modal_edit_province" tabindex="-1" aria-hidden="true">
                            ...
                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                ...
                                <div class="modal-content">
                                    <!--begin::Form-->
                                    <form class="form" action="{{ route('province.update' , 1) }}" method="post"
                                    >
                                    ...
                                    <!--begin::Modal header-->
                                        <div class="modal-header" id="kt_modal_add_customer_header">
                                            <!--begin::Modal title-->
                                            <h2 class="fw-bolder">{{ __('translation.edit_province') }}</h2>
                                            <!--end::Modal title-->
                                            <!--begin::Close-->
                                            <div id="kt_modal_add_customer_close"
                                            data-bs-dismiss="modal" aria-label="Close"
                                        ...
                                        <div class="modal-body py-10 px-lg-17">
                                            ...
                                            <div class="form-group mb-2 ">
                                                <label for=""
                                                    >{{ __('translation.area') }}</label>
                                                <select id='area_edit_select'  data-placeholde='Hello' style='width:100%' name='area_id'
...
<script>
   function  ShowEditModel(id, name, area_id){
        // alert('Jksa');
        $('#kt_modal_edit_province').modal('show');
        console.log(id, name, area_id);
