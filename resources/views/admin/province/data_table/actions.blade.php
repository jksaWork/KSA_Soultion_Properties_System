...
<div style="min-width: 200px">
    ...
    type="button" data-bs-toggle="modal"
                                                    data-bs-target="#edit_bank_{{ $area->id }}"
    ...
    <div class="modal fade kt_modal_add_customer " id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
            ...
            <div class="modal-content">
                ...
                @csrf
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <!--begin::Scroll-->
                        <div class="form-group mb-2 area_select ">
                            <label for=""
    ...
    <div class="modal fade " id="kt_modal_add_customer_edit" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content">
    ...
    @endif
        ...
        <a href="#" onclick="SwitchStatus('{{ route('area.show' , ['area' => $area->id, 'status' => 1])}}')"
