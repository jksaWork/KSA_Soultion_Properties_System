...
{{-- @endif --}}
@section('main-head')
{{ __('translation.achivement_mangement') }}
<small> - {{ __('translation.achivement_new') }} </small>
@endsection
@push('links')
          ...
          <div class="card">
               ...
               <div class="card-header border-0 pt-6">
                    <div class="card-body pt-0">
                         ...
                         @include('layouts.includes.session')
                         <form action="{{ route('achivement.store')}}" method="post" id='owner_form' enctype="multipart/form-data">
                              @csrf
                              <div class="border rodunded-sm ">
                                   ...
                                   <div class="row px-3 mt-3">
                                        <x:select2-input name='client' :value='$contract->client_id' :option='$contract->Client' class='col-md-6' />
                                        <x:select2-input name='realstate' class='col-md-6' :value='$contract->client_id' :option='$contract->Realstate' />
                                        <x:select2-input name='type' class='col-md-6' :value='request()->type' :option='$type' :disabled='true' />
                                        <x:text-input name='amount' :value='$contract->amount' class='col-md-6' />
                                        <x:text-input name='payment_date' class='col-md-6' />
                                        <x:text-input name='contract_id' class='col-md-6' :value='$contract->id' />
                                   </div>
                              </div>
                              <div class="row p-10">
                                   <div class="col-md-6">
