...
<small> - {{ __('translation.add_contract') }} </small>
@endsection
@push('links')
          ...
          <div class="card">
               ...
               <div class="card-header border-0 pt-6">
                    <div class="card-body pt-0">
                         ...
                         @include('layouts.includes.session')
                         <form action="{{ route('contracts.store')}}" method="post" id='owner_form' enctype="multipart/form-data">
                              @csrf
                              <div class="border rodunded-sm ">
                                   ...
                                   <div class="row px-3 mt-3">
                                        <x:select2-input name='client' class='col-md-6' />
                                        <x:select2-input name='realstate' class='col-md-6' />
                                        <x:text-input name='contract_number' class='col-md-6' />
                                        <x:text-input name='end_date' class='col-md-6' />
                                        <x:text-input name='start_date' class='col-md-6' />
                                        <x:text-input name='contract_date' class='col-md-6' />
                                   </div>
