     ...
     <div id="kt_content_container" class="container-xxl">
          <div class="card p-5">
               <div class="card-body p-3">
                                   ...
                                   <div class="tile ">
                                        ...
                                        <div class="mx-2  border-0 ">
                                             ...
                                             <div class="d-flex justify-content-between">
                                                  <input type="text" id="data_search" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px" placeholder="{{ __('translation.search_on_subarea') }}">

                                                  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">{{ __('translation.add_subarea') }}</button>
                                                  <!--end::Add customer-->
                    ...
                    <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
                         ...
                         <div class="modal-dialog modal-dialog-centered mw-650px">
                              ...
                              <div class="modal-content">
                                   <!--begin::Form-->
                                   <form class="form" action="{{ route('subarea.store') }}" method="post">
                                        @csrf
                                        <!--begin::Modal header-->
                                        <div class="modal-header" id="kt_modal_add_customer_header">
                                             <!--begin::Modal title-->
                                             <h2 class="fw-bolder">{{ __('translation.add_subarea') }}</h2>
                                             <!--end::Modal title-->
                                             <!--begin::Close-->
                                        ...
                                        <div class="modal-body py-10 px-lg-17">
                                             ...
                                             <div class="form-group mt-4">
                                                  ...
                                                  <select id='provice_select' style='width:100%' name='province_id'>
                    ...
                    <div class="modal fade" id="kt_modal_edit_province" tabindex="-1" aria-hidden="true">
                         <!--begin::Modal dialog-->
                         <div class="modal-dialog modal-dialog-centered mw-650px">
                              <!--begin::Modal content-->
                              <div class="modal-content">
                                   <!--begin::Form-->
                                   <form class="form" action="{{ route('subarea.update' , 1) }}" method="post">
                                        ...
                                        <div class="modal-header" id="kt_modal_add_customer_header">
                                             <!--begin::Modal title-->
                                             <h2 class="fw-bolder">{{ __('translation.edit_subarea') }}</h2>
                                             <!--end::Modal title-->
                                             <!--begin::Close-->
                                             <div id="kt_modal_add_customer_close" data-bs-dismiss="modal" aria-label="Close" class="btn btn-icon btn-sm btn-active-icon-primary">
                                                  <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                                        ...
                                        <div class="modal-body py-10 px-lg-17">
                                             ...
                                             <div class="form-group mb-2 ">
                                                  <label for="">{{ __('translation.area') }}</label>
                                                  <select id='area_edit_select' data-placeholde='Hello Wolrd' style='width:100%' name='area_id'>
                                                       <option value='0'> {{ __('translation.chose_area') }}
                                                       </option>
                                             ...
                                             <div class="form-group mb-2  mt-4 ">
                                                  <label for="">{{ __('translation.province') }}</label>
                                                  <select id='province_edit_select' data-placeholde='Hello Wolrd' style='width:100%' name='province_id'>
                                                       <option value='0'> {{ __('translation.chose_province') }}
                                                       </option>
                                             ...
                                             <div class="scroll-y me-n7 pe-7" id="#">
                                                  <x:text-input class="col-md-12 name_edit_value" name='name' />
                                                  <input type="hidden" name="subarea_id" class='subarea_id'>
                                             </div>
               ...
               <script>
                let area_id;
                    function ShowEditModel(id, name, area_id1, province_id) {
                         // alert('Jksa');
                         $('#kt_modal_edit_province').modal('show');
                         console.log(id, name, area_id1, province_id);
                         // $("#area_edit_select").val(area_id);
                         area_id = area_id1;
                         $("#area_edit_select").select2("trigger", "select", {
                              data: {
                                   id: area_id
                              }
                         });

                         $("#province_edit_select").select2("trigger", "select", {
                              data: {
                                   id: province_id
                              }
                         });

                         $('#kt_modal_edit_province  input[name="name"]').val(name);
                         $('.subarea_id').val(id);
                    }

                    $("#area_edit_select").select2({
                         dropdownParent: $('#kt_modal_edit_province')
                         , ajax: {
                              url: "{{ route('area.ajax') }}"
                              , type: "get"
                              , dataType: 'json'
                    ...
                    $('#area_select').change((e) => {
                        // console.log();
                       area_id =  e.target.value ;
                    });
                    $("#province_edit_select").select2({
                         dropdownParent: $('#kt_modal_edit_province')
                         , ajax: {
