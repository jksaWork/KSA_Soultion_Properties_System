...
<div style="min-width: 200px">
    ...
    <div class="modal fade" id="edit_bank_{{ $area->id }}" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <!--begin::Modal content-->
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{ route('area.update' , $area->id) }}" method="post"
                >
                @method('PUT')
                @csrf
                    <!--begin::Modal header-->
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="scroll-y me-n7 pe-7" id="#updatemodel">
                            <x:text-input class="col-md-12" name='name'  value="{{ $area->name }}" />
                        </div>
