                                   ...
                                   <div class="tile ">
                                        ...
                                        <div class="mx-2  border-0 ">
                                             ...
                                             <div class="d-flex justify-content-between">
                                                  <input type="text" id="data_search" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px" placeholder="{{ __('translation.search_on_areas') }}">

                                                  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">{{ __('translation.add_area') }}</button>
                                                  <!--end::Add customer-->
                                                  ...
                                                  <table class="table datatable align-middle table-row-dashed fs-6 gy-5" id="roles-table" style="width: 100%;">
                                                       <thead>
                                                            <tr>
                                                                 ...
                                                                 <th class="text-center">{{ __('translation.provinces') }}</th>
