...
@push('links')
<link rel="stylesheet" type="text/css" href='{{ asset('countrySelect.min.css') }}' />
<style>
...
@endpush
@section('main-head',__('translation.nationnaltys'))
                                   ...
                                   <div class="tile ">
                                        ...
                                        <div class="mx-2  border-0 ">
                                             ...
                                             <div class="d-flex justify-content-between">
                                                  <input type="text" id="data_search" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px" placeholder="{{ __('translation.search_on_nationlty') }}">

                                                  <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">{{ __('translation.add_nationnalty') }}</button>
                                                  <!--end::Add customer-->
                    ...
                    <div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
                         ...
                         <div class="modal-dialog modal-dialog-centered mw-650px">
                              ...
                              <div class="modal-content">
                                   <!--begin::Form-->
                                   <form class="form" action="{{ route('nationnalty.store') }}" method="post">
                                        @csrf
                                        <!--begin::Modal header-->
                                        <div class="modal-header" id="kt_modal_add_customer_header">
                                             <!--begin::Modal title-->
                                             <h2 class="fw-bolder">{{ __('translation.add_nationalty') }}</h2>
                                             <!--end::Modal title-->
                                             <!--begin::Close-->
                                        ...
                                        <!--end::Modal header-->
                                        <!--begin::Modal body-->
                                        <div class="modal-body py-10 px-lg-17 h-[500px]">
                                             <!--begin::Scroll-->
                         ...
                         <div class="modal-dialog modal-dialog-centered mw-650px">
                              ...
                              <div class="modal-content">
                                   ...
                                   <form class="form" action="{{ route('banks.update' , 1) }}" method="post">
                                        ...
                                        <div class="modal-header" id="kt_modal_add_customer_header">
                                             <!--begin::Modal title-->
                                             <h2 class="fw-bolder">{{ __('translation.edit_nationalaity') }}</h2>
                                             <!--end::Modal title-->
                                             <!--begin::Close-->
                                             <div id="kt_modal_add_customer_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                                                  <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                                        ...
                                        <div class="modal-footer flex-start items-center">
                                             <!--begin::Button-->
                                             <button type="reset" id="kt_modal_add_customer_cancel" class="btn btn-light me-3">{{ __('translation.cancel') }}</button>
                                             <!--end::Button-->
                                             <!--begin::Button-->
                                             <button class="btn btn-primary"> {{ __('translation.save') }} </button>
                                             <!--end::Button-->
