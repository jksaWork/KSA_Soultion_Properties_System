...
<small> - {{ __('translation.add_real_state') }} </small>
@endsection
@push('links')
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                <div class="card-body pt-0">
                    ...
                    @include('layouts.includes.session')
                    <form action="{{ route('realstate.store')}}" method="post" id='owner_form'
                        ...
                        <div class="border rodunded-sm ">
                            ...
                            <div class="row px-3 mt-3">
                                ...
                                <x:text-input name='unit_number' class='col-md-3' />
                                {{--
                                <x:text-input name='phone' class='col-md-6' /> --}}
                                <div class="mt-2 col-12 row">
                                    {{-- Owners Section --}}
                                    <x:select2-input name='owner' class='col-md-4' />
                                    <x:text-input name='instrument_number' class='col-md-4' />
                                    <x:text-input name='instrument_date' class='col-md-4' />
                                    {{-- Sector Section --}}
                                    <x:select2-input name='spectator' class='col-md-4' />
                                    <x:text-input name='spectator_number' class='col-md-4' />
                                    <x:text-input name='spectator_date' class='col-md-4' />
                                    {{-- Agent --}}
                                    <x:select2-input name='agent' class='col-md-4' />
                                    <x:text-input name='agent_number' class='col-md-4' />
                                    <x:text-input name='agent_date' class='col-md-4' />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border rodunded-sm ">
                            ...
                            <div class="row px-3 mt-3">
                                ...
                                <x:text-input name='map_address' class='col-md-6' />
                                <x:text-input name='national_address' class='col-md-6' />
                            </div>
                            <div class="border rodunded-sm my-2">
                                ...
                                <div class="row m-3">
                                    ...
                                    <x:text-input name='electricity_service_number' class='col-md-6' />
